...
// This custom bottom sheet helps it to be showed under system status bar when the contain is longer than screen height
...
class _ModalBottomSheetState<T> extends State<_ModalBottomSheet<T>> {
  String _getRouteLabel(MaterialLocalizations localizations) {
    ...
    if (targetPlatform == TargetPlatform.iOS)
      return '';
    else if (targetPlatform == TargetPlatform.android || targetPlatform == TargetPlatform.fuchsia)
