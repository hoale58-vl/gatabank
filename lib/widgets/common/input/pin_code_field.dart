    ...
    return RotationTransition(
        child: DefaultTextStyleTransition(
          style: TextStyleTween(
              begin: TextStyle(color: Colors.pink), end: TextStyle(color: Colors.blue))
              .animate(animation),
...
class PinCodeTextField extends StatefulWidget {
  ...
  const PinCodeTextField({
    ...
    this.maskCharacter: " ",
    this.pinBoxWidth: 60.0,
    this.pinBoxHeight: 60.0,
    this.pinTextStyle,
    this.onDone,
  ...
  void initState() {
    ...
    if (widget.highlightAnimation) {
      _highlightAnimationController = AnimationController(
          vsync: this, duration: widget.highlightAnimationDuration ?? Duration(milliseconds: 500));
      ...
      _highlightAnimationColorTween = ColorTween(
          begin: widget.highlightAnimationBeginColor, end: widget.highlightAnimationEndColor)
