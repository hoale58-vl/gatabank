...
import 'package:gatabank/screens/credit_card/credit_card_cubit.dart';
...
class ScreenRouter {
  ...
  static const CREDIT_CARD_DETAIL = 'creditCardDetail';
  ...
  ScreenRouter(){
    ...
    cardRepo = CardRepository(api: mockAPI);
  }
  ...
  Function buildPageRoute(RouteSettings settings) {
    var blocProviders = [
      ...
      BlocProvider(create: (context) => CreditCardCubit(cardRepo)),
